...
export const DEFAULTS: Content = {
  ...
  faqs: [
    ...
    { id: "f2", question: "Can I book support for appliance faults as well as general repairs?",          answer: "Yes. PrimeFix London can help arrange support for both household repair issues and appliance faults so clients do not need to manage separate service journeys." },
    ...
    { id: "f4", question: "Do you cover drainage, locksmith, window repair and pest control?",            answer: "Yes. These services sit alongside core repair and appliance support so households can access specialist help through the same PrimeFix London contact point." },
    { id: "f5", question: "Is after-service support available?",                                          answer: "Yes. PrimeFix London keeps support available after the technician visit so clients have a clear route for follow-up questions or next steps." },
