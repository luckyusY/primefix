...
export function BookingProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    /* Scroll form back to top each open */
    if (dialogRef.current) {
      dialogRef.current.querySelector(".booking-modal__form-wrap")?.scrollTo(0, 0);
    }
  ...
  return (
    <BookingContext.Provider value={value}>
      ...
      {/* Always mounted — CSS controls visibility for instant open */}
      <div
      ...
      >
        ...
        <div className="booking-modal__dialog" ref={dialogRef}>
          {/* Close — positioned inside left panel */}
          <button
            type="button"
          ...
          <div className="booking-modal__copy">
            ...
            <div className="booking-modal__contact">
              ...
              <a href="tel:+447507113805" tabIndex={open ? 0 : -1}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.6 21 3 13.4 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8Z"/>
                </svg>
                +44 7507 113805
              </a>
              <a href="https://wa.me/447507113805" target="_blank" rel="noopener noreferrer" tabIndex={open ? 0 : -1}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
